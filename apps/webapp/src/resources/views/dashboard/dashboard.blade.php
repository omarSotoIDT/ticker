...
createApp({
    setup() {
        ...
        const cards = ref([
            { titulo: "Total Tickets", valor: "{{ $cards['total'] ?? 0 }}", descripcion: "Todos los tickets del sistema", icono: "fas fa-chart-line", color: "#3b82f6" },
            { titulo: "Tickets Activos", valor: "{{ $cards['activos'] ?? 0 }}", descripcion: "En proceso o pendientes", icono: "far fa-clock", color: "#f59e0b" },
            { titulo: "Tickets Cerrados", valor: "{{ $cards['cerrados'] ?? 0 }}", descripcion: "Finalizados exitosamente", icono: "far fa-check-circle", color: "#10b981" },
            { titulo: "Tickets Urgentes", valor: "{{ $cards['urgentes'] ?? 0 }}", descripcion: "Requieren atención inmediata", icono: "fas fa-exclamation-circle", color: "#ef4444" }
        ]);

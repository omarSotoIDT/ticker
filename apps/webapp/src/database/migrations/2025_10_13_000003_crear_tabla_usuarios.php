...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('usuarios', function (Blueprint $table) {
            ...
            $table->varchar('status', 255)->nullable(false);
            ...
            // Llaves foráneas
            $table->foreign('registro_autor_id')->references('usuario_id')->on('usuarios')->onDelete('set null');
            $table->foreign('actualizacion_autor_id')->references('usuario_id')->on('usuarios')->onDelete('set null');
            $table->foreign('colaborador_id')->references('usuario_id')->on('usuarios')->onDelete('set null');

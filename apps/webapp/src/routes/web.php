...
// Rutas de Perfiles
Route::prefix('perfiles')->middleware(['auth', 'permiso'])->group(function () {
...
// Rutas de Usuarios
Route::prefix('usuarios')->middleware(['auth', 'permiso'])->group(function () {
...
// Rutas de Proyectos
Route::prefix('proyectos')->middleware(['auth', 'permiso'])->controller(ProyectoController::class)->group(function () {
...
// Rutas de Clientes
Route::prefix('clientes')->controller(ClienteController::class)->middleware(['auth', 'permiso'])->group(function () {
...
// Rutas de Tickets
Route::prefix('tickets')->middleware(['auth', 'permiso'])->group(function () {
